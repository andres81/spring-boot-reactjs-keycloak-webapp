...
*/
package eu.andreschepers.authservice.domain.dto.validation.validator;
...
public class EqualPasswordsValidator implements ConstraintValidator<EqualPasswords, SignupDto> {
    ...
    public boolean isValid(SignupDto value, ConstraintValidatorContext context) {
        if (StringUtils.equals(value.getPassword(), value.getRepassword())) {
            return true;
        }
        return false;
    }
